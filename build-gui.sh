...
emcc -DJS_GUI -s ASM_JS=0 `ls *.c | grep -v '^main\.c'` --embed-file prefix.txt --shell-file gui/emcc-template.html -s ALLOW_MEMORY_GROWTH=1 -o gui/main.html -s EXPORTED_FUNCTIONS="['_handle_gui_line', '_do_setup', '_jsgui_error_handler']"
